...
macro_rules! sql_operator {
    ($vis:vis $ident:ident, $lit:literal) => {
        ...
        impl<'args, T> $ident<T>
        where
            T: ::sqlx::Type<::sqlx::Any> + ::sqlx::Encode<'args, ::sqlx::Any> + 'args,
        {
            #[inline]
        ...
        $crate::sql_impl! {
            ...
            where
                T: ::sqlx::Type<::sqlx::Any> + ::sqlx::Encode<'args, ::sqlx::Any>
        }
...
macro_rules! sql_operator {
    ($vis:vis $ident:ident, $lit:literal) => {
        ...
        impl<'args, T> $ident<T>
        where
            T: ::sqlx::Type<::sqlx::MySql> + ::sqlx::Encode<'args, ::sqlx::MySql> + 'args,
        {
            #[inline]
            $vis fn new(column: &'static str, value: Option<T>) -> Self {
                Self { column, value }
        ...
        $crate::sql_impl! {
            ...
            where
                T: ::sqlx::Type<::sqlx::MySql> + ::sqlx::Encode<'args, ::sqlx::MySql>
        }
...
macro_rules! sql_operator {
    ($vis:vis $ident:ident, $lit:literal) => {
        ...
        impl<'args, T> $ident<T>
        where
            T: ::sqlx::Type<::sqlx::Sqlite> + ::sqlx::Encode<'args, ::sqlx::Sqlite> + 'args,
        {
            #[inline]
            $vis fn new(column: &'static str, value: Option<T>) -> Self {
                Self { column, value }
        ...
        $crate::sql_impl! {
            ...
            where
                T: ::sqlx::Type<::sqlx::Sqlite> + ::sqlx::Encode<'args, ::sqlx::Sqlite>
        }
